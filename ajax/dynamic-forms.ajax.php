...
class DynamicFormsController
{
    ...
    {
        $url =
            'columns?id=' . $this->id_column . '&nameId=id_column&token=' . $this->token . '&table=admins&suffix=admin';
        $method = 'PUT';
    ...
    {
        $url =
            'columns?id=' . $this->id_prompt . '&nameId=id_column&token=' . $this->token . '&table=admins&suffix=admin';
        $method = 'PUT';
