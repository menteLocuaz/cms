    ...
    public function manageModule()
    {
        if (isset($_POST['title_module'])) {
            ...
            if (isset($_POST['id_module'])) {
                            ...
                            if (!empty($indexColumns)) {
                                foreach ($indexColumns as $key => $value) {
                                    ...
                                    if ($_POST['id_column_' . $value] > 0) {
                                        $url =
                                            'columns?id='
                                            . $_POST['id_column_' . $value]
                                            . '&nameId=id_column&token='
                                            . $_SESSION['admin']->token_admin
                                            . '&table=admins&suffix=admin';
                                        $method = 'PUT';
                                        $data =
                                            ...
                                            . '&alias_column='
                                            . $_POST['alias_column_' . $value]
                                            . '&type_column='
                                            . $_POST['type_column_' . $value]
                                            . '&visible_column='
                                            . $_POST['visible_column_' . $value];
                ...
                $url =
                    'modules?linkTo=title_module,type_module&equalTo='
                ...
                if ($createModule->status == 200) {
                    ...
                    if ($_POST['type_module'] == 'tables') {
                        ...
                        $directory =
                            DIR . '/views/pages/dynamic/custom/' . str_replace(' ', '_', $fields['title_module']);
