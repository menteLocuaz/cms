...
class AdminsController
{
    ...
    public function login()
    {
        if (isset($_POST['email_admin'])) {
            ...
            if ($login->status == 200) {
                ...
                echo
                    '<div class="alert alert-danger mt-3 rounded">Error al ingresar: '
                        . $login->results
                        . '</div>
    ...
    public function updateAdmin()
    {
        if (isset($_POST['id_admin'])) {
            ...
            $url =
                'admins?linkTo=id_admin&equalTo='
                . base64_decode($_POST['id_admin'])
                . '&select=id_admin,password_admin,rol_admin';
            $method = 'GET';
            $fields = array();
        ...
        if (isset($_POST['resetPassword'])) {
            ...
            if ($admin->status == 200) {
                ...
                if ($updatePassword->status == 200) {
                    ...
                    $message =
                        '<h4 style="font-weight: 100; color:#999; padding:0px 20px"><strong>Su nueva contraseña: '
                        . $newPassword
